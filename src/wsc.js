const wscByNumber = {
    ...
    2: {
        ...
        answer:
            'The Word of God, which is contained in the Scriptures of the Old and New Testaments, [1] is the only rule to direct us how we may glorify and enjoy him. [2]',
        proofTexts: {
            '1': [
                'Matt. 19:4-5 with Gen. 2:24',
                'Luke 24:27, 44',
                'I Cor. 2:13; 14:37',
    ...
    3: {
        ...
        answer:
            'The Scriptures principally teach what man is to believe concerning God, [1] and what duty God requires of man [2].',
        proofTexts: {
    ...
    4: {
        ...
        answer:
            'God is a Spirit [1], infinite [2], eternal [3], and unchangeable [4] in his being [5], wisdom [6], power [7], holiness [8], justice [9], goodness [10], and truth [11].',
        proofTexts: {
            '1': [
                'Deut. 4:15-19',
                'Luke 24:39',
    ...
    6: {
        ...
        answer:
            'There are three persons in the Godhead; the Father, the Son, and the Holy Ghost [1]; and these three are one God, the same in substance, equal in power and glory. [2]',
        proofTexts: {
    ...
    9: {
        ...
        answer:
            "The work of creation is, God's making all things of nothing, by the word of his power [1], in the space of six days, and all very good. [2]",
        proofTexts: {
    ...
    10: {
        ...
        answer:
            'God created man male and female, after his own image [1], in knowledge [2], righteousness, and holiness [3], with dominion over the creatures [4].',
        proofTexts: {
            '1': ['Gen. 1:27'],
            '2': ['Col. 3:10'],
            '3': ['Eph. 4:24'],
    ...
    11: {
        ...
        answer:
            "God's works of providence are, his most holy [1], wise [2], and powerful [3] preserving [4] and governing [5] all his creatures, and all their actions [6].",
        proofTexts: {
            '1': ['Ps. 145:17'],
            '2': ['Ps. 104:24'],
            '3': ['Heb. 1:3'],
    ...
    15: {
        ...
        answer:
            'The sin whereby our first parents fell from the estate wherein thy were created, was their eating the forbidden fruit [1].',
        proofTexts: {
            '1': ['Gen. 3:6']
        }
    },
    16: {
        ...
        answer:
            'The covenant being made with Adam [1], not only for himself, but for his posterity; all mankind, descending from him by ordinary generation, sinned in him, and fell with him, in his first transgression [2].',
        proofTexts: {
            '1': ['Gen. 2:16-17', 'Jas. 2:10'],
    ...
    18: {
        ...
        answer:
            "The sinfulness of that estate whereinto man fell, consists in the guilt of Adam's first sin [1], the want of original righteousness [2], and the corruption of his whole nature [3], which is commonly called original sin; together with all actual transgressions which proceed from it [4].",
        proofTexts: {
            '1': ['Rom. 5:12, 19'],
    ...
    19: {
        ...
        answer:
            'All mankind by their fall lost communion with God [1], are under his wrath [2] and curse [3], and so made liable to all miseries in this life [4], to death [5] itself, and to the pains of hell for ever [6].',
        proofTexts: {
    ...
    20: {
        ...
        answer:
            'God having, out of his mere good pleasure, from all eternity, elected some to everlasting life [a,] did enter into a covenant of grace, to deliver them out of the estate of sin and misery, and to bring them into an estate of salvation by a Redeemer [2].',
        proofTexts: {
    ...
    24: {
        ...
        answer:
            'Christ executeth the office of a prophet, in revealing to us, by his Word [1] and Spirit [b,] the will of God for our salvation [3].',
        proofTexts: {
    ...
    28: {
        ...
        answer:
            "Christ's exaltation consisteth in his rising again from the dead on the third day [1], in ascending up into heaven [2], in sitting at the right hand [3] of God the Father, and in coming to judge the world at the last day [4].",
        proofTexts: {
            '1': ['I Cor. 15:4'],
    ...
    36: {
        ...
        answer:
            "The benefits which in this life do accompany or flow from justification, adoption, and sanctification, are, assurance of God's love [1], peace of conscience [2], joy in the Holy Ghost [3], increase of grace [4], and perseverance therein to the end [5].",
        proofTexts: {
            '1': ['Rom. 5:5'],
            '2': ['Rom. 5:1'],
            '3': ['Rom. 14:17'],
    ...
    37: {
        ...
        answer:
            'The souls of believers are at their death made perfect in holiness [1], and do immediately pass into glory [2]; and their bodies, being still united to Christ [3], do rest in their graves till the resurrection [4].',
        proofTexts: {
            '1': ['Heb. 12:23'],
    ...
    46: {
        ...
        answer:
            'The first commandment requireth us to know and acknowledge God to be the only true God, and our God; and to worship and glorify him accordingly [1].',
        proofTexts: {
    ...
    54: {
        ...
        answer:
            "The third commandment requireth the holy and reverend use of God's names, titles [1], attributes [2], ordinances [3], Word [4], and works [5].",
        proofTexts: {
    ...
    55: {
        ...
        answer:
            'The third commandment forbiddeth all profaning or abusing of anything whereby God maketh himself known [1].',
        proofTexts: {
    ...
    59: {
        ...
        answer:
            'From the beginning of the world to the resurrection of Christ, God appointed the seventh day of the week to be the weekly sabbath [1]; and the first day of the week ever since, to continue to the end of the world, which is the Christian sabbath [2].',
        proofTexts: {
    ...
    61: {
        ...
        answer:
            'The fourth commandment forbiddeth the omission or careless performance of the duties required, and the profaning the day by idleness, or doing that which is in itself sinful, or by unnecessary thoughts, words, or works, about our worldly employments or recreations [1].',
        proofTexts: {
    ...
    64: {
        ...
        answer:
            'The fifth commandment requireth the preserving the honor, and performing the duties, belonging to everyone in their several places and relations, as superiors, inferiors, or equals [1].',
        proofTexts: {
            '1': [
                'Rom. 13:1, 7',
    ...
    65: {
        ...
        answer:
            'The fifth commandment forbiddeth the neglecting of, or doing anything against, the honor and duty which belongeth to everyone in their several places and relations [1].',
        proofTexts: {
    ...
    69: {
        ...
        answer:
            'The sixth commandment forbiddeth the taking away of our own life, or the life of our neighbour, unjustly, or whatsoever tendeth thereunto [1].',
        proofTexts: {
    ...
    71: {
        ...
        answer:
            "The seventh commandment requireth the preservation of our own and our neighbour's chastity, in heart, speech, and behavior [1].",
        proofTexts: {
    ...
    72: {
        ...
        answer:
            'The seventh commandment forbiddeth all unchaste thoughts, words, and actions [1].',
        proofTexts: {
    ...
    74: {
        ...
        answer:
            'The eighth commandment requireth the lawful procuring and furthering the wealth and outward estate of ourselves and others [1].',
        proofTexts: {
    ...
    75: {
        ...
        answer:
            "The eighth commandment forbiddeth whatsoever doth, or may, unjustly hinder our own, or our neighbour's, wealth or outward estate [1].",
        proofTexts: {
    ...
    77: {
        ...
        answer:
            "The ninth commandment requireth the maintaining and promoting of truth between man and man, and of our own and our neighbour's good name [1], especially in witness bearing [2].",
        proofTexts: {
    ...
    78: {
        ...
        answer:
            "The ninth commandment forbiddeth whatsoever is prejudicial to truth, or injurious to our own, or our neighbour's, good name [1].",
        proofTexts: {
    ...
    81: {
        ...
        answer:
            'The tenth commandment forbiddeth all discontentment with our own estate [1], envying or grieving at the good of our neighbour, and all inordinate motions and affections to anything that is his [2].',
        proofTexts: {
    ...
    82: {
        ...
        answer:
            'No mere man, since the fall, is able in this life perfectly to keep the commandments of God, but doth daily break them in thought, word, and deed [1].',
        proofTexts: {
    ...
    85: {
        ...
        answer:
            'To escape the wrath and curse of God, due to us for sin, God requireth of us faith in Jesus Christ, repentance unto life [1], with the diligent use of all the outward means whereby Christ communi]cateth to us the benefits of redemption [2].',
        proofTexts: {
    ...
    87: {
        ...
        answer:
            'Repentance unto life is a saving grace [1], whereby a sinner, out of a true sense of his sin, and apprehension of the mercy of God in Christ [2], doth, with grief and hatred of his sin, turn from it unto God [3], with full purpose of, and endeavour after, new obedience [4].',
        proofTexts: {
    ...
    88: {
        ...
        answer:
            'The outward and ordinary means whereby Christ communicateth to us the benefits of redemption are, his ordinances, especially the Word, sacraments, and prayer; all which are made effectual to the elect for salvation [1].',
        proofTexts: {
    ...
    90: {
        ...
        answer:
            'That the Word may become effectual to salvation, we must attend thereunto with diligence, preparation, and prayer [1]; receive it with faith and love, lay it up in our hearts, and practice it in our lives [2].',
        proofTexts: {
    ...
    92: {
        ...
        answer:
            'A sacrament is an holy ordinance instituted by Christ [1]; wherein, by sensible signs, Christ, and the benefits of the new covenant, are represented, sealed, and applied to believers [2].',
        proofTexts: {
            '1': [
                'Matt. 28:19; 26:26-28',
                'Mark 14:22-25',
    ...
    97: {
        ...
        answer:
            "It is required of them that would worthily partake of the Lord's Supper, that they examine themselves of their knowledge to discern the Lord's body, of their faith to feed upon him, of their repentance, love, and new obedience; lest, coming unworthily, they eat and drink judgment to themselves [1].",
        proofTexts: {
            '1': ['I Cor. 11:27-32']
        }
    },
    98: {
        ...
        answer:
            'Prayer is an offering up of our desires unto God [1], for things agreeable to his will [2], in the name of Christ [3], with confession of our sins [4], and thankful acknowledgement of his mercies. [5]',
        proofTexts: {
    ...
    100: {
        ...
        answer:
            "The preface of the Lord's Prayer, which is, Our Father which art in heaven, teacheth us to draw near to God with all holy reverence [1] and confidence [2], as children to a father [3], able and ready to help us [4]; and that we should pray with and for others [5].",
        proofTexts: {
            '1': ['Ps. 95:6'],
            '2': ['Eph. 3:12'],
    ...
    102: {
        ...
        answer:
            "In the second petition, which is, Thy kingdom come, we pray, that Satan's kingdom may be destroyed [1]; and that the kingdom of grace may be advanced [2], ourselves and others brought into it, and kept in it [3]; and that the kingdom of glory may be hastened [4].",
        proofTexts: {
    ...
    103: {
        ...
        answer:
            'In the third petition, which is, Thy will be done in earth, as it is in heaven, we pray, that God, by his grace, would make us able and willing to know, obey, and submit to his will in all things [1], as the angels do in heaven [2].',
        proofTexts: {
